...
import { Loader2, User, Plus, Play, Trash2, Users } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
        ...
        title={
          world && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <span>{t('charactersList.title')}</span>
                <p className="text-red-300 text-base font-normal">{world.name}</p>
              </div>
            </div>
          )
        }
